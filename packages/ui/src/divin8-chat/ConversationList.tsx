...
export default function ConversationList({
  ...
  const showConversations = mode !== "profiles";
  const showProfiles = mode !== "conversations";
  ...
  return (
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2">
                    ...
                    >
                      ...
                      <p
                        className={classNames(
                          ...
                          isLightTheme ? "text-slate-500" : "text-white/45",
                        )}
                      >
                      ...
                      <p
                        className={classNames(
                          "mt-0.5 text-[10px]",
                          isLightTheme ? "text-slate-350" : "text-white/25",
                        )}
                      >
              ...
              {threads.length === 0 ? (
                <div
                  className={classNames(
                    ...
                    isLightTheme ? "border-slate-200 text-slate-500" : "text-white/55",
                  )}
                  style={!isLightTheme ? darkChatStyles.panelAlt : undefined}
                >
                  {searchQuery.trim()
        ...
        {showProfiles ? (
          <div className={showConversations ? "mt-5" : ""}>
