export const PROMO_TARGETS = {
  ...
  PRIME_BODY_HEALING: "prime_body_healing",
  PRIME_BODY_HEALING_LEVEL_1: "prime_body_healing:level_1",
  PRIME_BODY_HEALING_LEVEL_2: "prime_body_healing:level_2",
...
export const PROMO_TARGET_LABELS: Record<PromoTarget, string> = {
  ...
  [PROMO_TARGETS.PRIME_BODY_HEALING]: "Prime Body Healing",
  [PROMO_TARGETS.PRIME_BODY_HEALING_LEVEL_1]: "Prime Body Healing Level 1",
  [PROMO_TARGETS.PRIME_BODY_HEALING_LEVEL_2]: "Prime Body Healing Level 2",
