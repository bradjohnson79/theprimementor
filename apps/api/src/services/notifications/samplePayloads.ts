...
const SAMPLE_PAYLOAD_FACTORIES: SamplePayloadFactoryMap = {
  ...
  "webinar.confirmed": () => ({
    entityId: "webinar_confirmed_sample",
    bookingId: "booking_webinar_confirmed",
    eventId: "adronis-disclosure-to-contact-2026",
    eventTitle: "Adronis: From Disclosure to Contact",
    presenter: "Brad Johnson channeling Adronis",
    displayDate: "Saturday, September 12, 2026",
    displayTime: "10:00 AM Pacific / 1:00 PM Eastern",
    startTimeUtc: new Date("2026-09-12T17:00:00.000Z").toISOString(),
    timezone: "America/Los_Angeles",
