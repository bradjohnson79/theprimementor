...
export default function ChatToolModal({
  ...
  return (
    <div className="fixed inset-0 left-64 top-16 z-[60] flex" role="dialog" aria-modal="true" aria-label={title}>
      <div
      ...
      <div
        ...
        className={classNames(
          "relative z-10 flex max-h-full min-h-0 flex-col border shadow-2xl",
          isDrawer
      ...
      >
        ...
        >
          ...
          <button
            ...
            aria-label="Close"
            className={classNames(
              "flex h-8 w-8 items-center justify-center rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-cyan/70",
              isLightTheme
