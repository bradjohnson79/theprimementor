...
const tooltipBaseClassName =
  "pointer-events-none absolute bottom-14 rounded-lg border border-white/10 bg-slate-950/95 px-3 py-2 text-xs font-medium text-white shadow-[0_12px_30px_rgba(15,23,42,0.5)] transition duration-200";

export default function SupportButton({ isOpen, showTooltip, onClick, align }: SupportButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`${tooltipBaseClassName} ${align === "left" ? "left-0" : "right-0"} ${
